            ...
            <div class = "col-4">
                <div class = "card">
                    <div class = "card-body">
                        ...
                        <button type = "button" class = "btn btn-danger" data-target = "#deleteBookModal" onClick = "deleteBookModal(${book.isbn})"> Delete </button>
                        <button types = "button" class = "btn btn-primary" 
                            data-toggle = "modal" data-target = "#editBookModal" onClick = "setEditModal(${book.isbn})"> Edit
                        </button>
                    </div>
                </div>
            </div>
...
loadBooks();
async function deleteBookModal(isbn){
